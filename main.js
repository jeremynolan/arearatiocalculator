...
function squarecalc() {
  ...
  var area_of_wall = 2 *
    ...
    (parseFloat(s_dimension) + parseFloat(s_dimension));
...
function rectcalc() {
  ...
  document.getElementsByName("arRatio")[0].value = parseFloat(
    area_of_ration
  ).toFixed(2);
...
function hlfcalc() {
  ...
  var area = (parseFloat(length) * parseFloat(width)) / 2 +
    2 * (((parseFloat(length) / 2) * parseFloat(parseFloat(width) / 2)) / 2);

  var c = (parseFloat(length) / 2) * (parseFloat(length) / 2) +
    (parseFloat(width) / 2) * (parseFloat(width) / 2);

  var volume = (2 * (parseFloat(length) / 2) +
    parseFloat(width) +
    2 * parseFloat(Math.sqrt(c)).toFixed(2)) *
    thickness;
  ...
  if (val == 1) {
    var area1 = (parseFloat(length * 39.37) * parseFloat(width * 39.37)) / 2 +
      2 *
      (((parseFloat(length * 39.37) / 2) *
      parseFloat(parseFloat(width * 39.37) / 2)) /
      2);
...
function otcalc() {
  ...
  var area = parseFloat(length) * parseFloat(width) * (2 / 3) +
    (2 * ((parseFloat(length) / 3) * (parseFloat(width) / 2))) / 2;
  var C = ((parseFloat(length) / 3) * parseFloat(length)) / 3 +
    (parseFloat(width) / 2) * (parseFloat(width) / 2);
  var volume = (2 * parseFloat(length) * (2 / 3) + parseFloat(width) + 2 * Math.sqrt(C)) *
    thickness;
  ...
  if (val == 1) {
    var area_mm = parseFloat(length * 39.37) * parseFloat(width * 39.37) * (2 / 3) +
      (2 *
      ((parseFloat(length * 39.37) / 3) * (parseFloat(width * 39.37) / 2))) /
      2;
